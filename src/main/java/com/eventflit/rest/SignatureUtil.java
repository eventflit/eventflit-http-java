...
public class SignatureUtil {
    ...
    private static String bodyMd5(final String body) {
        ...
        // If this doesn't exist, we're pretty much out of luck.
            ...
            throw new RuntimeException("The Eventflit HTTP client requires MD5 support", e);
        }
        catch (final UnsupportedEncodingException e) {
            throw new RuntimeException("The Eventflit HTTP client needs UTF-8 support", e);
        }
    }
    ...
    public static String sign(final String input, final String secret) {
        ...
        // If either of these doesn't exist, we're pretty much out of luck.
            ...
            throw new RuntimeException("The Eventflit HTTP client requires HmacSHA256 support", e);
        }
        catch (final UnsupportedEncodingException e) {
            throw new RuntimeException("The Eventflit HTTP client needs UTF-8 support", e);
        }
